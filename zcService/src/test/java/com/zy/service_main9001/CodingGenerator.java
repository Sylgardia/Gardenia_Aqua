...
public class CodingGenerator {
    ...
    private static final String url = "jdbc:mysql://39.98.107.99:3306/word?allowPublicKeyRetrieval=true&useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
...
//                            .outputDir(System.getProperty("user.dir") + "\\src\\main\\java")    // 指定输出目录
                            .outputDir("D:\\IT\\studyProjects\\Azy_gardenia\\Spring\\spring-boot-template\\service\\mainService\\service_main-9001" + "/src/main/java")    // 指定输出目录
                ...
                .packageConfig(builder -> {
                    builder.parent("com.zy")                    // 设置父包名
                            .moduleName("service_main9001")     // 设置父包模块名
...
//                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\IT\\studyProjects\\IDEA Files\\Spring\\spring-boot-template\\service\\mainService\\service_main-9001" + "\\src\\main\\resources\\mappers")) // 设置 mapperXml 生成路径;
                            .other("other");
                })
                // 策略配置
