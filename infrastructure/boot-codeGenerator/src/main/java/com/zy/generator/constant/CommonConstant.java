...
public interface CommonConstant {
     ...
     * 长时间未手机校验 511
     */
    public static final Integer NO_MOBILE_PHONE_CHECK = 511;
    ...
    public final static String X_ACCESS_PLATFORM = "X-Access-Platform" ;
    public final static String X_REGIST_ID = "X-Regist-Id" ;
    ...
    public final static String BOSS_ID = "boss-id" ;
     ...
     * 系统平台
     */
    public String PLATFORM_ADMIN = "ADMIN" ;
    public String PLATFORM_OWNER_PC = "OWNER_PC" ;
    public String PLATFORM_OWNER_APP = "OWNER_APP" ;
    public String PLATFORM_DRIVER = "DRIVER_APP" ;
    public String PLATFORM_AGENT_APP = "AGENT_APP" ;
    public String PLATFORM_AGENT_PC = "AGENT_PC" ;

    /**
     * 系统角色
     */
    public String ROLE_ADMIN = "admin" ;
    public String ROLE_CONSIGNOR = "consignor" ;
    public String ROLE_EMPLOYEE = "employee" ;
    public String ROLE_DRIVER = "driver" ;
    public String ROLE_AGENT = "agent" ;


    public String VEHICLE_REF_TYPE_MINE = "0" ;
    public String VEHICLE_REF_TYPE_MANGE = "1" ;
    public String VEHICLE_REF_TYPE_USED = "2" ;

    public int CONSIGNOR_TYPE_PERSONAL = 0;
    public int CONSIGNOR_TYPE_COMPANY = 1;
    public int AGENT_TYPE_PERSONAL = 0;
    public int AGENT_TYPE_COMPANY = 1;

    public String EMPTY_IDS = "empty" ;

    public String ZJXL_TOKEN = "zjxl_token" ;

    public String MSG_TMS = "tms" ;
    public String TMS_AUTH_DRIVER = "tms_auth_driver" ;
